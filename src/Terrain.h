...
class Terrain : public SceneObject
{
  ...
  public:
    ...
    virtual void initialize()
    {
        ...
        shader = new Shader("shaders/terrain.vert", "shaders/terrain.frag", "shaders/terrain.geom", "shaders/terrain.tesc", "shaders/terrain.tese");
        ...
        bias = glm::mat4(glm::vec4(0.5f, 0.0f, 0.0f, 0.0f), glm::vec4(0.0f, 0.5f, 0.0f, 0.0f), glm::vec4(0.0f, 0.0f, 0.5f, 0.0f),
