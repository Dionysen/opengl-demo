...
void Frustum::setProjectionData(const float near, const float far,
...
void Frustum::setCameraData(const glm::vec3 &position, const glm::vec3 &view,
                            const glm::vec3 &up) {
...
void Frustum::setCameraOrientation(const glm::vec3 &view, const glm::vec3 &up,
