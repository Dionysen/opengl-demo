...
class Transform
{
  public:
    ...
    void setRotation(
        float x, float y, float z, Space space,
        Space pivot);  // space -> space of the angle values, pivot -> rotation pivot point (WORLD or LOCAL origins)
    ...
    inline void setLocalXVector(float x, float y, float z)
    {
        localAxis[0].x                       = x;
        localAxis[0].y                       = y;
        localAxis[0].z                       = z;
    ...
    inline void setLocalYVector(float x, float y, float z)
    {
        localAxis[1].x                       = x;
        localAxis[1].y                       = y;
        localAxis[1].z                       = z;
    ...
    inline void setLocalZVector(float x, float y, float z)
    {
        localAxis[2].x                       = x;
        localAxis[2].y                       = y;
        localAxis[2].z                       = z;
    ...
    inline const glm::vec3& getLocalXVector()
    {
    ...
    inline const glm::vec3& getLocalYVector()
    {
    ...
    inline const glm::vec3& getLocalZVector()
    {
