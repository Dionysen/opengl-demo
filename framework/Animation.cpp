...
void Animation::ReadMissingBones(const aiAnimation* animation, AnimationModel& model)
{
    ...
    auto& boneInfoMap = model.GetBoneInfoMap();  // getting m_BoneInfoMap from AnimationModel class
    int&  boneCount   = model.GetBoneCount();    // getting the m_BoneCounter from AnimationModel class
